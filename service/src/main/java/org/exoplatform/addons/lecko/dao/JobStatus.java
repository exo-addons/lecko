...
public class JobStatus {
  ...
  @Id
  @SequenceGenerator(name = "SEQ_TASK_LECKO_JOB_STATUS_ID", sequenceName = "SEQ_TASK_LECKO_JOB_STATUS_ID")
  @GeneratedValue(strategy = GenerationType.AUTO, generator = "SEQ_TASK_LECKO_JOB_STATUS_ID")
